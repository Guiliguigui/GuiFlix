...
{
    public partial class FirstsModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ListMedia", x => new { x.ListsId, x.MediasId });
                    table.ForeignKey(
                        name: "FK_ListMedia_Lists_ListsId",
                        column: x => x.ListsId,
                        principalTable: "Lists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ListMedia_Medias_MediasId",
                        column: x => x.MediasId,
